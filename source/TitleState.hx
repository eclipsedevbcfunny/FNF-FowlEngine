...
class TitleState extends MusicBeatState
{
	...
	var wackyIntros:Array<Array<String>> = [
		['removed ng', 'buggy code'], ['fowluhhdev', 'because funny'], ['creds to spycupcake88', 'he did nothing'], ['we rollin', 'uh what'], ['mister squidward', 'why are you depressed']];
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			// credTextShit.screenCenter();
			case 5:
				createCoolText(['FowlEngine', 'By']);
			case 7:
				addMoreText('FowluhhDev');
				ngSpr.visible = true;
			// credTextShit.text += '\nNewgrounds';
			case 8:
				deleteCoolText();
