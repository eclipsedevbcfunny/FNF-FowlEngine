...
class PlayState extends MusicBeatState
{
	...
	public var accuracyNum:Float = 0.00;
	public var accuracyFinal:Float = 0.00;
	...
	private var hbBFcol:Any;
	private var hbDadCol:Any;
	...
	override public function create()
	{
		...
		healthBar.createFilledBar(hbDadCol, hbBFcol);
		add(healthBar);

		scoreTxt = new FlxText(healthBarBG.x + healthBarBG.width - 190, healthBarBG.y + 30, 0, "", 20);
		scoreTxt.setFormat(AssetPaths.vcr__ttf, 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	override public function update(elapsed:Float)
	{
		...
		accuracyNum = notesHit - misses	/ notesHit;
		var accAlmost =  accuracyNum / (notesHit + misses) * 100;
		accuracyFinal = Math.ceil(accAlmost);
		...
		if (health <= 0)
		{
			...
			FlxG.switchState(new GameOverState(0, 0));
		}
